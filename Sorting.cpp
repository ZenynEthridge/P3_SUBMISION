...
//void QuickSortAllTests()
//{
//	// test 1
//	int testSet1[] = { 1, 8, 3, 5, 8, 2, 9 };
//	int keySet1[] = { 1, 2, 3, 5, 8, 8, 9 };
//	size_t size1 = sizeof(testSet1) / sizeof(testSet1[0]);
//	QuickSortUnitTest(size1, testSet1, keySet1);
//
//	// test 2
//	int keySet2[] = { 9, 8, 8, 5, 3, 2, 1 };
//	bool (*lambda2)(int, int) =
//		[](int t1, int t2) { return ((t1 > t2)); };
//	QuickSortUnitTest(size1, testSet1, keySet2, lambda2);
//
//	// test 3
//	char testSet3[] = { 'q','w','e','r','t','y' };
//	char keySet3[] = { 'e','q','r','t','w','y' };
//	size_t size3 = sizeof(testSet3) / sizeof(testSet3[0]);
//	bool (*lambda3)(char, char) =
//		[](char c1, char c2) { return (c1 < c2); };
//	QuickSortUnitTest(size3, testSet3, keySet3, lambda3);
//
//	// test 4
//	int testSet4[] = { -1,-8,-4,-2 };
//	int keySet4[] = { -8,-4,-2,-1 };
//	size_t size4 = sizeof(keySet4) / sizeof(keySet4[0]);
//	QuickSortUnitTest(size4, testSet4, keySet4);
//
//	// test 5
//	std::string testSet5[] = { "Dog", "Cat", "Alpha", "Beta" };
//	std::string keySet5[] = { "Alpha", "Beta", "Cat", "Dog" };
//	size_t size5 = sizeof(testSet5) / sizeof(testSet5[0]);
//	QuickSortUnitTest(size5, testSet5, keySet5);
//	std::cout << "\nAll tests passed for quick sort!\n";
//}
